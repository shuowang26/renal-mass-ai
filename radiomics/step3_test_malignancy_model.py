...
# This script loads radiomics model for malignancy prediction.
...
scaler = joblib.load('radiomics/trained_models/model01_scaler.pkl')
cv_results = joblib.load('radiomics/trained_models/model01_cv_results.pkl')
...
y_test = np.array(y_test > 0).astype(int)  # binary classification label for malignancy
